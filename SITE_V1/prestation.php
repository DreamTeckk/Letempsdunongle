						...
						if($_SESSION['rang'] == 'administrateur'){
							while($donnees = $requete->fetch()){
								...
								<?php
									...
									<a class="edit_button" href="editer_tarif.php?id_tarif=<?php echo $donnees['id_tarif'];?>"><img src="images/edit.png" alt="bouton supprimer" title="Editer tarif"/></a>
									<a class="remove_button" href="supprimer_tarif.php?id_tarif=<?php echo $donnees['id_tarif'];?>"><img src="images/remove.png" alt="bouton supprimer" title="Supprimer tarif"/></a>
								</div>
								<?php
							}
						?>
						<br />
						<a class="add_button" href="ajouter_tarif.php"><img src="images/add.png" alt="bouton ajouter" title="Ajouter tarif"/></a>
